...
def test_concurrent_create_drop_race_condition(cluster):
    ...
    these operations (by another node or concurrent query), it should not cause a crash.
    ...
    try:
        ...
        # A logical error would indicate the race condition caused a crash (chassert failure)
