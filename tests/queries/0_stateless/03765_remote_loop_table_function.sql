...
SELECT 1 FROM remote('localhost', loop('default', 't0_03765')) tx; -- { serverError TOO_MANY_RETRIES_TO_FETCH_PARTS }

INSERT INTO t0_03765 VALUES (1),(2),(3);

-- With data: selecting a constant should work
SELECT 1 FROM remote('127.0.0.1', loop('default', 't0_03765')) LIMIT 3;

-- With data: selecting actual columns should work
SELECT * FROM remote('127.0.0.1', loop('default', 't0_03765')) LIMIT 5;
